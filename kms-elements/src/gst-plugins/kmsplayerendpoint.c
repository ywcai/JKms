    ...
    KmsPlayerEndpoint * self)
{
  ...
  if (agnosticbin != NULL) {
    ...
    //the fakesink is a black hole ,the src data is input but do noting and can not out put .
  }
...
GST_WARNING("the PlayEndpoint on the c  ============ start ! ");
...
{
  GST_WARNING("   kms_player_endpoint_class_init   =========================START !");
